...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/vendors/css/extensions/unslider.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/vendors/css/weather-icons/climacons.min.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/fonts/meteocons/style.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/vendors/css/charts/morris.css') }}">
  <!-- END VENDOR CSS-->
  <!-- BEGIN STACK CSS-->
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/fonts/simple-line-icons/style.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/css/core/colors/palette-gradient.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/home/app-assets/css/pages/timeline.css') }}">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
...
data-open="click" data-menu="vertical-menu" data-col="2-columns">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" alt="stack admin logo" src="{{ asset('assets/home/app-assets/images/logo/stack-logo-light.png') }}">
              ...
              <ul class="mega-dropdown-menu dropdown-menu row">
                <li class="col-md-2">
                  ...
                  <div id="mega-menu-carousel-example">
                    <div>
                      <img class="rounded img-fluid mb-1" src="{{ asset('assets/home/app-assets/images/slider/slider-2.png') }}"
                  ...
                  <div class="tweet-slider">
                    <ul>
                      <li>Congratulations to Rob Jones in accounting for winning our
                        <span class="yellow">#NFL</span> football pool!
                      ...
                      <li>Puns, humor, and quotes are great content on
                        <span class="yellow">#Twitter</span>. Find some related to your business.
                        <p class="text-italic pt-1">- John Doe</p>
                      </li>
                      <li>Are there
                        <span class="yellow">#common-sense</span> facts related to your business? Combine
  ...
  <script src="{{ asset('assets/home/app-assets/vendors/js/charts/raphael-min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/home/app-assets/vendors/js/charts/morris.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/home/app-assets/vendors/js/extensions/unslider-min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('assets/home/app-assets/vendors/js/timeline/horizontal-timeline.js') }}" type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN STACK JS-->
  ...
  <!-- END STACK JS-->
  <!-- BEGIN PAGE LEVEL JS-->
  <script src="{{ asset('assets/home/app-assets/js/scripts/pages/dashboard-ecommerce.js') }}" type="text/javascript"></script>
  <!-- END PAGE LEVEL JS-->
</body>
</html>