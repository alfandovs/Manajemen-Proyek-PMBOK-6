		...
		<div class="col-xs-12">
			<div class="grid invoice">
				<div class="grid-body">
					...
					<center><h3> Project Schedule</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan Dokumen Project Schedule yang berisi tentang semua informasi jadwal dan kegiatan proyek yang akan dikerjakan</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>Aplikasi Bank Sampah</strong><br></td>
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><strong>{{ $gnc->end }}</strong><br></td>
										<td class="text-right"><strong>{{ $gnc->kegiatan }}</strong></td>
									</tr>
									@endforeach
								</tbody>
							</table>
