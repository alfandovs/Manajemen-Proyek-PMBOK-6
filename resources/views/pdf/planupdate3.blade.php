		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <h3>Work Data Report</h3>
                            <table class="table table-striped">
                                <thead>
                                    <tr class="line">
                                        <td><strong>No.</strong></td>
                                        <td class="text-center"><strong>Name</strong></td>
                                        <td class="text-center"><strong>Estimate</strong></td>
                                        <td class="text-center"><strong>Planed</strong></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>{{ $k->estimate }}</strong><br></td>
                                        <td><strong>{{ $k->planned }}</strong><br></td>
                                        <td><strong>{{ $k->actual }}</strong><br></td>
