                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr class="line">
                                        ...
                                        <td class="text-center"><strong>Deliverables</strong></td>
                                        <td class="text-center"><strong>Criteria</strong></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>{{ $s->project }}</strong><br></td>
                                        <td><strong>{{ $s->description }}</strong><br></td>
                                        <td><strong>{{ $s->deliverables }}</strong><br></td>
                                        <td><strong>{{ $s->criteria }}</strong><br></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
