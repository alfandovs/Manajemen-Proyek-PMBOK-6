		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Project Charter</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan Project Charter dari pembuatan website/mobile</td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr class="line">
                                            ...
                                            <td class="text-center"><strong>Tanggal Berhenti</strong></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i=1 ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong>Pengingat Jika ada banjir</strong><br></td>
                                            <td><strong>Aplikasi Mobile(User) Aplikasi Website(Admin)</strong></td>
                                            <td><strong></strong>03 Maret 2022</td>
                                            <td><strong></strong>08 Juni 2022</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
						...
						<div class="col-md-10">
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										<td><?php echo $i; $i++;?></td>
										<td><strong>{{ $c->batasan }}</strong><br></td>
									</tr>
                                    @endforeach
								</tbody>
							</table>
						...
						<div class="col-md-10">
							...
							<table class="table table-striped">
								...
								<tbody>
									...
									<tr>
										<td><?php echo $i; $i++;?></td>
										<td><strong>{{ $c->resiko }}</strong><br></td>
									</tr>
                                    @endforeach
								</tbody>
							</table>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>{{ $c->kriteria }}</strong><br></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>{{ $c->asumsi }}</strong><br></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
