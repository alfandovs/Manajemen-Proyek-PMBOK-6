		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Project Dokumen Update</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>Aplikasi Asuransi</strong><br></td>
                                        <td><strong>Esa Dandy</strong><br></td>
                                        <td><strong>2022-02-15</strong><br></td>
                                        <td><strong>2022-05-01</strong><br></td>
                                        <td><strong>Close</strong><br></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>Famos Matching Free</strong><br></td>
                                        <td><strong>Esa Dandy</strong><br></td>
                                        <td><strong>2022-03-23</strong><br></td>
                                        <td><strong>2022-06-16</strong><br></td>
                                        <td><strong>Close</strong><br></td>
                                    </tr>
                                </tbody>
                            </table>
