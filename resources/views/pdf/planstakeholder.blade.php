		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Stakeholder Plan</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan dokumen pemangku kepentingan antara pemilik proyek dan perusahaan</td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                            <div class="col-md-10">
                                <h3>Stakeholder Plan</h3>
                                <table class="table table-striped">
                                    <thead>
                                        <tr class="line">
                                            <td><strong>No.</strong></td>
                                            <td class="text-center"><strong>Klien Name</strong></td>
                                            <td class="text-center"><strong>Type</strong></td>
                                            <td class="text-center"><strong>Level</strong></td>
                                            <td class="text-center"><strong>Ability</strong></td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $i; $i++;?></td>
                                            <td><strong>{{ $p->client }}</strong><br></td>
                                            <td><strong>{{ $p->type }}</strong><br></td>
                                            <td><strong>{{ $p->level }}</strong></td>
                                            <td><strong>{{ $p->ability }}</strong></td>
