		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Cost Management Plan</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan kumpulan jadwal proyek yang telah bekerjasama dengan PT. Tekno Mandala Kreatif</td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="row">
                            <div class="col-md-10">
                                <h3>Management Schedule</h3>
                                <table class="table table-striped">
                                    <thead>
                                        <tr class="line">
                                            <td><strong>No.</strong></td>
                                            <td class="text-center"><strong>Name</strong></td>
                                            <td class="text-center"><strong>Biaya Total</strong></td>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i=1 ?>
