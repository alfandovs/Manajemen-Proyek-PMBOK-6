		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Work Performance Data</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan dokumen yang berisi tentang hasil kinerja dari pengerjaan suatu proyek</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>Dilihat dari beberapa data yang ada proyek dapat berjalan dengan baik untuk saat ini dan diperkirakan sesuai tujuan</strong><br></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>								
