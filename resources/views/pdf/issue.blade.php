                        ...
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan dokumen yang berisi tentang masalah yang dihadapi dari pengerjaan suatu proyek</td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="col-md-10">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr class="line">
                                        <td><strong>No.</strong></td>
                                        <td class="text-center"><strong>Issue Tittle</strong></td>
                                        <td class="text-center"><strong>Report Date</strong></td>
                                        <td class="text-center"><strong>Report By</strong></td>
                                        <td class="text-center"><strong>Priority</strong></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>{{ $w->issue }}</strong><br></td>
                                        <td><strong>{{ $w->report }}</strong><br></td>
                                        <td><strong>{{ $w->reportby }}</strong><br></td>
                                        <td><strong>{{ $w->priority }}</strong><br></td>
                                        <td><strong>{{ $w->status }}</strong><br></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
