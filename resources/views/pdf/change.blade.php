		...
		<div class="row">
			...
			<div class="col-xs-12">
				<div class="grid invoice">
                    ...
                    <center><h3>Change Request</h3></center>
                    <br>
                    <br>
                    <div class="row">
                        <div class="col-md-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Abstrak</th>
                                        <td>Dokumen Ini Merupakan kumpulan data Perubahan dari klien atau pemilik aplikasi</td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr class="line">
                                        ...
                                        <td class="text-center"><strong>Perubahan</strong></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i=1 ?>
                                    ...
                                    <tr>
                                        <td><?php echo $i; $i++;?></td>
                                        <td><strong>{{ $pr->name }}</strong><br></td>
                                        <td><strong>{{ $pr->client }}</strong><br></td>
                                        <td><strong>{{ $pr->saran }}</strong></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
